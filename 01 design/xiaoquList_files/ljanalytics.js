...
switch (window.location.hostname) {
    ...
    case 'us.lianjia.com':
        ...
        break;
    case 'ja.lianjia.com':
        ga('create', 'UA-79735954-1', 'auto');
        ga('send', 'pageview');
        break;
    case 'nz.lianjia.com':
        ga('create', 'UA-79753022-1', 'auto');
        ga('send', 'pageview');
        break;
    case 'uk.lianjia.com':
    ...
    switch (hostname) {
        ...
        default :
            if (hostname.match(/^(us|ca|uk|au)\.lianjia\.com/g) !== null) {
                ...
                pid = 'lianjiamweb';
            } else if (hostname.match(/^(\S+\.)*(bj|sh|gz|sz|tj|cd|nj|hz|qd|dl|xm|wh|cq|cs|xa|jn|sjz)\.lianjia\.com/g) !== null) {
                pid = 'lianjiaweb';
            }
            break;
    }
