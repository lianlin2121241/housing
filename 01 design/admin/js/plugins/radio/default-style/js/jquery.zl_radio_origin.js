    ...
    $.fn.zl_radio = function () {
			...
			radio_array.each(function( index, ele ){
								...
								eleObj.bind("click",function(){
									var topDocument=$(this).closest("body");
								 	$("div.zl_radio[name="+eleName+"]",topDocument).removeClass("zl_radio_down");
								 	$("div.zl_radio[name="+eleName+"]",topDocument).addClass("zl_radio_normal");
