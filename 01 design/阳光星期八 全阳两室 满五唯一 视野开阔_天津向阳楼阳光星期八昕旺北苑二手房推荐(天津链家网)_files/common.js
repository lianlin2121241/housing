...
!function (e) {
    e.fn.scrollLoading = function (t) {
        var n = {attr: "data-url", container: e(window), callback: e.noop}, a = e.extend({}, n, t || {});
        a.cache = [], e(this).each(function () {
            var t = this.nodeName.toLowerCase(), n = e(this).attr(a.attr), r = {obj: e(this), tag: t, url: n};
            a.cache.push(r)
        });
        var r = function (t) {
            ...
            t = e(window).get(0) === window ? e(window).scrollTop() : a.container.offset().top, e.each(a.cache, function (e, a) {
                var o = a.obj, i = a.tag, s = a.url;
                if (o) {
                    var c = o.offset().top - t, l = c + o.height();
                    (c >= 0 && n > c || l > 0 && n >= l) && (s ? "img" === i ? r(o.attr("src", s)) : o.load(s, {}, function () {
                        r(o)
                    }) : r(o), a.obj = null)
                }
            })
        };
        o(), a.container.bind("scroll", o)
    }
}(jQuery), function (e, t, n, a) {
    var r = e(t);
    e.fn.lazyload = function (o) {
        ...
        return o && (a !== o.failurelimit && (o.failure_limit = o.failurelimit, delete o.failurelimit), a !== o.effectspeed && (o.effect_speed = o.effectspeed, delete o.effectspeed), e.extend(l, o)), s = l.container === a || l.container === t ? r : e(l.container), 0 === l.event.indexOf("scroll") && s.bind(l.event, function () {
            return i()
        }), this.each(function () {
            var t = this, n = e(t);
            t.loaded = !1, (n.attr("src") === a || n.attr("src") === !1) && n.is("img") && n.attr("src", l.placeholder), n.one("appear", function () {
                if (!this.loaded) {
                    if (l.appear) {
                        var a = c.length;
                        l.appear.call(t, a, l)
                    ...
                    e("<img />").bind("load", function () {
                        ...
                        n.hide(), n.is("img") ? n.attr("src", a) : n.css("background-image", "url('" + a + "')"), n[l.effect](l.effect_speed), t.loaded = !0;
        ...
        var i;
        return i = o.container === a || o.container === t ? (t.innerHeight ? t.innerHeight : r.height()) + r.scrollTop() : e(o.container).offset().top + e(o.container).height(), i <= e(n).offset().top - o.threshold
    }, e.rightoffold = function (n, o) {
        var i;
        return i = o.container === a || o.container === t ? r.width() + r.scrollLeft() : e(o.container).offset().left + e(o.container).width(), i <= e(n).offset().left - o.threshold
    }, e.abovethetop = function (n, o) {
        var i;
        return i = o.container === a || o.container === t ? r.scrollTop() : e(o.container).offset().top, i >= e(n).offset().top + o.threshold + e(n).height()
    }, e.leftofbegin = function (n, o) {
        var i;
        return i = o.container === a || o.container === t ? r.scrollLeft() : e(o.container).offset().left, i >= e(n).offset().left + o.threshold + e(n).width()
    ...
    e.fn.fixtop = function (t) {
        var n = e.extend({
            ...
            zIndex: 1e3,
            fixedWidth: "100%"
        }, t), a = this.offset().top - n.marginTop, r = this, o = (r.height() + n.marginTop, e("<div/>").css({
        ...
        return e(window).scroll(function (t) {
            ...
            e(this).scrollTop() > i && "fixed" != r.css("position") && (r.after(o), r.css({
                ...
                "z-index": n.zIndex,
                width: n.fixedWidth
            }), void 0 !== n.fixed && n.fixed(r)), e(this).scrollTop() < i && "fixed" == r.css("position") && (o.remove(), r.css({
                position: "relative",
                top: "0px",
                "z-index": n.zIndex
    ...
    e = String(e);
    var n = Array.prototype.slice.call(arguments, 1), a = Object.prototype.toString;
    return n.length ? (n = 1 == n.length && null !== t && /\[object Array\]|\[object Object\]/.test(a.call(t)) ? t : n, e.replace(/#\{(.+?)\}/g, function (e, t) {
        var r = n[t];
        return "[object Function]" == a.call(r) && (r = r(t)), "undefined" == typeof r ? "" : r
    })) : e
}, $.trimN = function (e) {
    return e.replace(/\n{2,}/gm, "\n")
    ...
    var a = String(e), r = n || /#\{([^}]*)\}/gm, o = String.trim || function (e) {
            return e.replace(/^\s+|\s+$/g, "")
        };
    return a.replace(r, function (e, n) {
        return e = t[o(n)]
    })
    ...
    return n.length ? (n = 1 == n.length && null !== t && /\[object Array\]|\[object Object\]/.test(a.call(t)) ? t : n, e.replace(/#\{(.+?)\}/g, function (e, t) {
        var r = n[t];
        return "[object Function]" == a.call(r) && (r = r(t)), "undefined" == typeof r ? "" : $.encodeHTML(r)
    })) : e
}, $.showIframeImg = function (e, t) {
    var n = "<style>body{margin:0;padding:0}img{width:#{0}px;height:#{1}px;}</style>", a = $(e), r = a.height(), o = a.width(), i = $.stringFormat(n, o, r), s = "frameimg" + Math.round(1e9 * Math.random());
    window.betafang[s] = "<head>" + i + '</head><body><img id="img-' + s + "\" src='" + t + "' /></body>", e.append('<iframe style="display:none" id="' + s + '" src="javascript:parent.betafang[\'' + s + '\'];" frameBorder="0" scrolling="no" width="' + o + '" height="' + r + '"></iframe>')
    ...
    var a = {url: "", charset: "utf-8", complete: $.noop, fail: $.noop};
    if ($.extend(a, e), !a.url)throw"url is requireed";
    var r = !1, o = document.createElement("script"), i = document.getElementsByTagName("head")[0], s = $.Deferred();
    return o.onload = t, o.onerror = n, o.onreadystatechange = function (e) {
        "complete" == o.readyState && t()
    }, o.type = "text/javascript", o.src = a.url, o.charset = a.charset, i.appendChild(o), s
}, $.TextAreaUtil = function (e) {
    var t = document.selection, n = {
        getCursorPosition: function (e) {
            ...
            if (t) {
                ...
                try {
                    ...
                    a = t.createRange();
                    var r = a.duplicate();
                    r.moveToElementText(e), r.setEndPoint("EndToEnd", a), e.selectionStartIE = r.text.length - a.text.length, e.selectionEndIE = e.selectionEndIE + a.text.length, n = e.selectionStartIE
                } catch (o) {
                    n = e.value.length
                }
...
$(function () {
    ...
    e.closest("form").on("submit", function () {
        var e = $(this), t = e.attr("data-action") || e.attr("action"), n = e.find(".txt"), a = $.trim(n.val());
        return a == n.attr("placeholder") && (a = ""), t += encodeURIComponent(a), "_blank" != e.attr("target") ? (window.location.href = t, !1) : void e.attr("action", t)
    })
...
var ajax = function () {
    ...
    return e.get = function (e, n, a, r) {
        return a = a || t, r = r || t, e ? void $.getJSON(e, n, function (e) {
            0 === e.status ? a(e.data) : r(e)
        }, function (e) {
            var t = {status: 500, statusInfo: "服务请求失败"};
            r(t)
        }) : !1
    }, e.post = function (e, n, a, r) {
        return a = a || t, r = r || t, e ? void $.ajax({
...
define("common/ajax", function () {
    ...
    function e(e, t) {
        ...
        a.type = "text/javascript", a.src = e, t = t || function () {
    ...
    function t(t, n, r) {
        var o = "cbk_" + Math.round(1e4 * Math.random()), i = a + "?from=" + n + "&to=4&x=" + t.lng + "&y=" + t.lat + "&callback=BMap.Convertor." + o;
        r = r || function () {
            }, e(i), BMap.Convertor[o] = function (e) {
    ...
    function n(t, n, r) {
        var o = a + "?from=" + n + "&to=4&mode=1", i = [], s = [], c = 20;
        r = r || function () {
            };
        var l = function () {
            var t = "cbk_" + Math.round(1e4 * Math.random()), n = o + "&x=" + i.join(",") + "&y=" + s.join(",") + "&callback=BMap.Convertor." + t;
            e(n), i = [], s = [], BMap.Convertor[t] = function (e) {
        ...
        for (var u in t)u % c === 0 && 0 !== u && l(), i.push(t[u].lng), s.push(t[u].lat), u == t.length - 1 && l()
    }
...
var LJFixed = function (e, t) {
    function n(t) {
        if (!r.isSupportPlaceHolder) {
            var n = e(t), a = n.attr("placeholder");
            "" === n.val() && n.val(a).addClass("placeholder"), n.focus(function () {
    ...
    var r = {isSupportPlaceHolder: "placeholder" in t.createElement("input")};
    e(function () {
        a()
    }), e.fixPlaceholder = n;
    var o = {};
...
var Pagination = function (require) {
    function e(e, t, n) {
        var a = [];
        if (n = n || 6, t = t || 1, n >= e)for (var r = 0; e > r; r++)a.push(r + 1); else {
            a.push(1), t > 4 && a.push("");
            for (var o = Math.max(t - 2, 2), i = Math.min(t + 2, e - 1), r = o; i >= r; r++)a.push(r);
            e - 3 > t && a.push(""), a.push(e)
        }
        return a
    }
    ...
    function t(e, t, n, a) {
        ...
        if (n = n || 1, e && e.length) {
            ...
            for (var i = e.length, s = 0; i > s; s++)o.push(e[s] ? "<a " + (e[s] == n ? 'class="on"' : "") + ' href="' + r(e[s]) + '" data-page="' + e[s] + '">' + e[s] + "</a>" : "<span>...</span>");
            t > n && t > 6 && o.push('<a href="' + r(n + 1) + '" data-page="' + (n + 1) + '">下一页</a>')
        }
        return o.join("")
    }
        ...
        function o() {
            if (!(c.totalPage <= 1)) {
                ...
                if (c.dom.html(a), c.targetWrapper) {
                    ...
                    r.hide(), r.eq(c.curPage - 1).show(), c.targetWrapper.find(".lj-lazy").lazyload()
                }
            }
        }
...
define("common/pagination", function () {
    ...
    function e() {
        ...
        n.host = e.host, n.scheme = e.scheme, n.port = e.port;
    ...
    var n = {host: "", scheme: "", port: "", env: "online"}, a = {};
    return a.getEnv = function () {
        ...
        var r = $.parseURL(e);
        return r.host ? (r.host = a.fixedHost(r.host), r.port = n.port, r.scheme || (r.scheme = n.scheme)) : (r.host = n.host, r.scheme = n.scheme, r.port = n.port), t(r)
    ...
    function t(e, t) {
        this.targets = {}, this.name = e, this.listenFunc = [], n = t || n, "string" != typeof n && (n = n.toString()), this.initListen()
    }

    var n = "[LIANJIA_Messenger_CROSS]", a = "postMessage" in window;
    ...
    function str(e, t) {
        ...
        switch (c && "object" == typeof c && "function" == typeof c.toJSON && (c = c.toJSON(e)), "function" == typeof rep && (c = rep.call(t, e, c)), typeof c) {
            ...
            case"object":
                ...
                if (rep && "object" == typeof rep)for (o = rep.length, n = 0; o > n; n += 1)"string" == typeof rep[n] && (a = rep[n], r = str(a, c), r && i.push(quote(a) + (gap ? ": " : ":") + r)); else for (a in c)Object.prototype.hasOwnProperty.call(c, a) && (r = str(a, c), r && i.push(quote(a) + (gap ? ": " : ":") + r));
                return r = 0 === i.length ? "{}" : gap ? "{\n" + gap + i.join(",\n" + gap) + "\n" + s + "}" : "{" + i.join(",") + "}", gap = s, r
        }
    }
    ...
    function e(e, t) {
        ...
        return n.id = e, n.name = e, n.src = t, n.style.cssText = "display:none;width:0px;height:0px;", n.width = 0, n.height = 0, n.title = "empty", document.body.appendChild(n), n
    }
    ...
    var n = {}, a = function (e, t) {
        var n = this;
        n.domain = e, t = t || $.parseURL(e).host.replace(/\./g, "-"), n.name = t, n.init()
    };
    return $.extend(a.prototype, {
        init: function () {
            var n = this, a = n.domain + "/xd/api/?name=" + n.name, r = e(n.name, a);
            n.iframe = r.contentWindow, t.addTarget(n.iframe, n.name), n.reqArray = [], t.targets[n.name].deal = function (e, a) {
                t.targets[n.name].isRequest = !1;
                var r = n.reqArray.shift(), o = !1;
                try {
                    o = e
                } catch (i) {
                }
                a ? r.defer.resolve(o) : r.defer.reject(o), n.next()
            ...
            if (t.targets[e.name].readyState && e.reqArray.length && !t.targets[e.name].isRequest) {
                ...
                var n = e.reqArray[0], a = {type: "request", data: n.request}, r = JSON.stringify(a);
                t.targets[e.name].send(r)
            }
        }, request: function (e) {
            var t = this, n = $.Deferred();
            return t.reqArray.push({defer: n, request: e}), t.next(), n
        }
    }), function (e, t) {
        return n[e] ? n[e] : n[e] = new a(e, t)
    }
}), define("xd/Trans", function (require) {
    var e = $.EventEmitter, t = require("xd/crossRequest"), n = require("common/env"), a = !1, r = e.extend({
        initialize: function (e) {
            var r = {url: "", type: "get", dataType: "json", args: {}};
            $.extend(r, e), r.url = n.fixedUrl(r.url), r.method = r.type;
            var o = this;
            if (o.opt = r, !a) {
            ...
            var t = this, n = t.opt;
            return $.extend(n.args, e), n.data = n.args, a || t.isSame ? $.ajax(n) : this.crossRequest.request(n)
        }
    });
    return r
    ...
    function n() {
        if (!c) {
            ...
            "test" == $.env.getEnv() ? t.src = "http://passport.off.lianjia.com/cas/js/passport.js" : "dev" === s ? t.src = "http://passport.lianjia.com:8088/cas/js/passport.js" : t.src = "https://passport.lianjia.com/cas/js/passport.js", t.type = "text/javascript", t.charset = "utf-8", t.onload = e, document.getElementsByTagName("head")[0].appendChild(t)
        }
    }

    function a() {
        return className = $(this).attr("class"), $(".overlay_bg").fadeIn(300), $(".panel_login").removeAttr("class").addClass("panel_login animated " + className).fadeIn(), $("body").css({overflow: "hidden"}), n(), !1
    }

    function r() {
        var e = new $.Trans({url: $.env.fixedUrl("http://login.lianjia.com/login/getUserInfo/"), type: "jsonp"});
    ...
    function o(e) {
        ...
        if ($("#userNews").length > 0) {
            ...
            n.request().done(function (t) {
                t = t && t.data, t && t.unread_num && e.append('<span class="login_bubble_tip">' + t.unread_num + "</span>"), $("#userNews").html($.template($("#News").html()).render({data: t}))
            })
        }
    }

    var i, s = require("common/env"), c = (require("xd/Trans"), !1), l = !1, s = $.env.getEnv();
    return i = "test" === s ? "http://passport.off.lianjia.com/cas/captcha.htm" : "dev" === s ? "http://passport.lianjia.com:8088/cas/captcha.htm" : "http://passport.lianjia.com/cas/captcha.htm", $(document.body).ready(function () {
        function e() {
            $(".panel_login").fadeOut(), $(".overlay_bg").fadeOut(), $("body").css({overflow: ""}), $("#dialog").removeClass("bounceIn")
        }

        function n(e) {
            e = e || "用户名或者密码错误", s.find("dd").html(e), s.show()
        }
        ...
        var o = $(".verImg"), s = $("#con_login_user").find(".show-error");
        o.on("click", function () {
            var e = +new Date;
            $(this).attr("src", i + "?t=" + e)
        }), $(".typeUserInfo").delegate(".btn-login", "click", a), $(".overlay_bg,.claseDialogBtn").click(function () {
            e()
        }), $("#con_login_user").delegate("input", "keyup", function (e) {
            13 == e.keyCode && $(".login-user-btn").click()
        }), $(".login-user-btn").on("click", function (e) {
            var a = $("#con_login_user").find(".item"), i = ($("#con_login_agent").find(".item"), a.find(".users").val()), s = a.find(".password").val();
            if (!i)return void a.find(".users").focus();
            if (!s)return void a.find(".password").focus();
            var c = $("#con_login_user").find('[name="remember"]').get(0), l = {username: i, password: s, code: ""};
            if (c && c.checked && (l.remember = 1), "none" != $(".checkVerimg").css("display")) {
                var u = $(".ver-img").val();
                if (!/^\d{4}$/.test(u))return n("验证码格式错误"), void $(".ver-img").focus();
                l.code = u
            }
            r(), t(function () {
        ...
        init: function () {
            ...
            $.listener.on("userInfo", function (t) {
                e(t), t.username && o($(".typeUserInfo").find(".typeShowUser a").eq(0))
            }), r()
        }, openLoginDialog: a
    }
    ...
    function a(e) {
        s.length || n(!0), s.push(e)
    }

    function r(e) {
        var t = $.inArray(e, s);
        t >= 0 && s.splice(t, 1), s.length || n(!1)
    }
    ...
    function e(e) {
        for (var n, a = !1, r = i.width(), s = window.innerHeight, c = 0, l = o.length; l > c; c++)n = o[c], a = t(n, e, r, s), a && !n.always && --n.times <= 0 && (o.splice(c, 1), l--, c--)
    }

    function t(e, t, n, a) {
        var r = $(e.el);
        t || (t = document.documentElement.scrollTop || document.body.scrollTop), n || (n = i.width()), a || (a = window.innerHeight);
        var o = r.offset(), s = o.top - e.marginTop, c = s + r.height() + e.marginBottom, l = t, u = t + a;
    ...
    var a, r = require("common/scrollCaller"), o = [], i = $(window);
    return function (e) {
        var r = {el: "", marginTop: 0, marginBottom: 0, times: 1, always: !1, callback: $.noop};
        if ($.extend(r, e), r.el) {
            var i = t(r);
            if (!i || r.always)return o.push(r), a || n(), {
                destroy: function () {
                    var e = o.indexOf(r);
                    e >= 0 && o.splice(e, 1)
                }, pause: function () {
    ...
    function e() {
        ...
        $(".link-list div").eq(0).show(), $(".link-footer div").eq(0).show(), e.delegate("span", "mouseover", function (e) {
            var t = $(e.currentTarget), n = t.index(), a = t.closest(".tab").next(".link-list");
    ...
    function a() {
        ...
        }), "ershoufang" == g.attr("actdata") && $(".savesearch").show(), p.delegate("li label", "click", function (t) {
            var n = $(t.currentTarget), a = n.parent("li").index(), r = n.attr("actdata");
            r = r.split("=")[1], g.text(n.text()), g.attr("actdata", r), p.css({display: "none"});
            var o = $.queryToJson(n.attr("actData"));
            o && defaultSuggest.suggestView.model.trans.setArgs(o);
            var i = $(this).attr("formact"), s = n.attr("tra"), c = n.attr("tips");
            n.closest(".search-txt").find("form").attr({
                action: i,
                target: s
            }), n.closest(".search-txt").find("form").attr({"data-action": i}), n.closest(".search-txt").find(".autoSuggest").attr("placeholder", c), e.eq(a).show().siblings("ul").hide();
            var l = n.closest(".search-txt").find(".autoSuggest");
            "placeholder" in document.createElement("input") ? l.val("") : l.val(c), "ershoufang" == r ? $(".savesearch").show() : $(".savesearch").hide(), u()
        })
    }
    ...
    function o() {
        var e = $(".feedback-box");
        $("#tel").val();
        e.delegate("#sub", "click", function () {
            var t = ($("#sub"), $("#tips")), n = "//www.lianjia.com/site/accuse/", a = ($("#count"), $("#tel").val()), r = $("#count").val();
            r = $.trim(r);
            var o = $("#count").attr("placeholder");
            if ("" == r || r == o)return $(".erro-tips").show(), !1;
            var i = {contact: a, content: r};
            $.ajax({
                type: "POST",
                url: n,
                dataType: "json",
        ...
        e.delegate(".ent", "click", function () {
            ...
            $.ajax({url: e, dataType: "jsonp", data: {city_id: ljConf.city_id}}).done(function (e) {
                var n = $(".feedback-box #list");
                n.html("");
                var e = e.data;
                if (e.data && e.data.length <= 0 && $("#tousu").hide(), e.data && 0 == e.code) {
                    for (var a = e.data, r = "", o = 0; o < a.length; o++) {
                        var i;
                        i = 1 == a[o].issue_status ? "未处理" : 2 == a[o].issue_status ? "处理中" : "已完成", r += $.replaceTpl(t, {
    ...
    function i() {
        ...
        e.fadeOut().removeClass("bounceIn"), e.html(m), v.fadeOut()
    }

    function s() {
        var e = $("#feedback"), t = $(".feedback-box");
        e.click(function (e) {
            t.show(), t.addClass("bounceIn"), v.fadeIn(300), t.html(m)
        }), v.click(function (e) {
            i()
        ...
        if ($(".search-tab .check").length > 0) {
            ...
            menu = t + n, $("#keyword-box").on("formSelect", function (e, t) {
                ...
                if ($("#keyword-box").attr("url")) {
                    ...
                    query = {name: t, url: n}, l(menu, query)
                } else {
                    var a = $(".search-txt form").attr("data-action"), t = $("#keyword-box").val(), n = "http://" + window.location.host + a + t;
                    "" != t && (query = {name: t, url: n}, l(menu, query))
                }
            });
            var a = $(".hot-sug");
            a.delegate("li a", "click", function (e) {
                var t = $(e.currentTarget);
                name = t.text(), url = t.attr("href"), query = {name: name, url: url}, l(menu, query)
            });
            var r = $("#suggest-cont");
            r.delegate("ul li", "click", function (e) {
                var t = $(e.currentTarget);
            ...
            if (o = JSON.parse(o), null != o) {
                ...
                var i = $(".hot-sug ul#" + t + " .list"), s = $(".hot-sug ul#" + t + " .hot-name"), c = i.html();
                s.text("搜索历史"), i.html(""), $.each(o, function (e, t) {
                    var n = '<li><a href="' + t.url + '" data-log_index="' + (e + 1) + '" data-log_value="' + t.name + '">' + $.encodeHTML(t.name) + "</a></li>";
                    i.append(n)
                });
                var u = $("#" + t + " .del");
                u.show(), u.click(function (e) {
                    localStorage.removeItem(menu), i.html(""), i.append(c), s.text("热门搜索"), u.hide(), "" == texval
                })
            }
        }
    }
    ...
    function f() {
        ...
        t.delegate(".more", "click", function (e) {
            var t = $(e.currentTarget), n = t.parent("ul");
            n.find(".list").css({height: "auto"}), t.hide()
    ...
    function d() {
        var e = $('[data-role="huodong-btn"]'), t = $('[data-role="huodong-mask"]'), n = $('[data-role="huodong-layer"]');
        e.length > 0 && (e.click(function () {
            t.fadeIn(500), n.addClass("bounceIn").show()
        }), n.click(function (e) {
            var a = $(e.target);
            (0 == a.closest('[data-role="huodong-wrap"]').length || a.closest(".close").length > 0) && (t.fadeOut(500), n.removeClass("bounceIn").fadeOut())
        }))
    }

    var h = require("common/lazyExecute"), p = $(".search-tab .tabs"), g = $(".search-tab .check"), m = $(".feedback-box").html(), v = $(".overlay_bg");
    return {
        init: function (i) {
            u(), t(), e(), a(), c(), d(), s(), o(), r(), f(), n()
        }
    }
}), function () {
        ...
        function e() {
            setTimeout(function () {
                $(".LOGVIEW:above-the-fold").each(function () {
                    var e = $(this);
                    LjUserTrack.send({typ: "show"}, e.get(0)), e.removeClass("LOGVIEW")
                }), e()
            }, 100)
        }

        function t() {
            $(document.body).on("mousedown", ".LOGCLICK", function () {
                LjUserTrack.send({typ: ""}, $(this).get(0))
            })
        }

        require("common/login").init();
        var n = $("#only");
        n.attr("data-city") && (n.attr("data-city").indexOf("su") >= 0 || n.attr("data-city").indexOf("jn") >= 0) && ($(".laisuzhou").addClass("laisuzhou-class"), $(document.body).delegate(".laisuzhou", "click", function (e) {
            return !1
        })), require("common/footer").init(), e(), t()
    })
}();